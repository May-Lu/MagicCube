...
<div class="row">
		<div class="col-sm-10 col-sm-offset-1">
			<h3 class="header smaller lighter blue">教练认证</h3>
  ...
  <div class="form-group">
   ...
   <div class="form-group ">
       ...
       <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2">女
         ...
         <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label">教练简介</label>
    <div class="col-sm-10">
    	  <textarea class="form-control" rows="3"id="textarea"></textarea>
    </div>
  </div>      
   <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label">教练证书图片</label>
    <div class="col-sm-10">
