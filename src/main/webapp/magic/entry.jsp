...
/*第二个菜单下的文档内容*/
.player	.container .content .menu2 .tab {
		display: none;
	}

.player	.container .content .menu2 .active{
		display: block;
	}

.player	.container .content .menu2 .tab p{
		font-size: 14px;
		line-height: 20px;
...
.player	.container .content .menu2 .tab .tt{
		font-size: 14px;
		font-weight: bold;

	}
/*第三个菜单下的文档内容*/
.player	.container .content .menu3 .tab {
		display: none;
	}

.player		.container .content .menu3 .active{
		display: block;
	}

.player	.container .content .menu3 .tab p{
		font-size: 14px;
		line-height: 20px;
		color: rgba(0,0,0,0.8);
        word-break:break-all;
...
.player	.container .content .menu3 .tab .tt{
		font-size: 13px;
		font-weight: bold;
