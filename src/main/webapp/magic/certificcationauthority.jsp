...
<div class="row">
		<div class="col-sm-10 col-sm-offset-1">
			<h3 class="header smaller lighter blue">认证官认证</h3>
  ...
  <div class="form-group">
   ...
   <div class="form-group ">
       ...
       <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2">女
           ...
           <div class="form-group  ">
                    <label for="brith" class="col-sm-2 control-label">生日：</label>  
                  <div class="input-group date form_datetime col-sm-10" data-date="1979-09-16T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
         ...
         <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label">认证官简介</label>
    <div class="col-sm-10">
    	  <textarea class="form-control" rows="3"id="textarea"></textarea>
    </div>
  </div>      
   <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label">认证官证书图片</label>
    <div class="col-sm-10">
