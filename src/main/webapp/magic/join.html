...
<html lang="en">
	...
	<link rel="stylesheet" type="text/css" href="assets/css/bootstrap-theme.min.css"></link>

	<link rel="stylesheet" type="text/css" href="assets/css/bootstrap-theme.min.css"></link>
	<link rel="stylesheet" type="text/css" href="assets/css/bootstrap3-wysihtml5.min.css"></link>
	<link rel="stylesheet" type="text/css" href="css/default.css"><!-- basic styles -->
...
<div class="row">
		<div class="col-sm-10 col-sm-offset-1">
			<h3 class="header smaller lighter blue">加盟信息</h3>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="firstname" placeholder="请输入名字">
         ...
         <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label">正文：</label>
    <div class="col-sm-10">
...
<![endif]-->
	...
	<script type="text/javascript" src="assets/js/bootstrap-wysihtml5.zh-CN.js"></script>
	<script>
